...
/**
 * Agent (B2B partner) session — a distinct cookie + token namespace from the
 * customer and admin sessions, so no token from one surface can ever be used to
 * reach another. HMAC-signed, httpOnly, secure in production.
 */
