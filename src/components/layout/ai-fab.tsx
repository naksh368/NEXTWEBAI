...
export function AiFab() {
  ...
  return (
    <Link
      ...
      className="group fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-brand-blue text-white shadow-cardHover transition-all hover:scale-105 hover:bg-brand-blueDark print:hidden"
    >
