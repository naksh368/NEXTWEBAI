  ...
  return (
    <div className="p-5">
      ...
      <form onSubmit={upload} className="space-y-2 rounded-xl border border-dashed border-surface-border p-4">
        ...
        <p className="text-xs font-medium text-brand-blue">✓ On upload, the customer is automatically emailed the file as a PDF/image attachment plus a secure My Trips link.</p>
      </form>
    </div>
  );
}
